...
+ (id)queryForPlaylistItems:(NSString *)part PlaylistId:(NSString*)playlistId{
    NSString *methodName = @"youtube.playlistItems.list";
    GTLQueryYouTube *query = [self queryWithMethodName:methodName];
    query.part = part;
    [query setCustomParameter:playlistId forKey:@"playlistId"];
    
    query.expectedObjectClass = [GTLYouTubePlaylistItemListResponse class];
    return query;
}

+ (id)queryForActivitiesListWithPart:(NSString *)part ChannelId:(NSString*)channelId{
    NSString *methodName = @"youtube.activities.list";
    GTLQueryYouTube *query = [self queryWithMethodName:methodName];
    query.part = part;
    [query setCustomParameter:channelId forKey:@"channelId"];
    query.expectedObjectClass = [GTLYouTubeActivityListResponse class];
    return query;
}


+ (id)queryForPlaylistItemsListWithPart:(NSString *)part Chart:(NSString*)chart{
    NSString *methodName = @"youtube.videos.list";
    GTLQueryYouTube *query = [self queryWithMethodName:methodName];
    query.part = part;
    [query setCustomParameter:chart forKey:@"chart"];
    query.expectedObjectClass = [GTLYouTubePlaylistItemListResponse class];
    return query;
}

+ (id)queryForChannelWithPart:(NSString *)part ID:(NSString*)ID{
    NSString *methodName = @"youtube.channels.list";
    GTLQueryYouTube *query = [self queryWithMethodName:methodName];
    query.part = part;
    [query setCustomParameter:ID forKey:@"id"];
...
+ (id)queryForSearchListWithPart:(NSString *)part :(NSString *) searchString{
  NSString *methodName = @"youtube.search.list";
  GTLQueryYouTube *query = [self queryWithMethodName:methodName];
  query.part = part;
    
    [query setCustomParameter:searchString forKey:@"q"];
